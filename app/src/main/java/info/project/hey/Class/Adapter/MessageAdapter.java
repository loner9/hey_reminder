...
import info.project.hey.Class.Model.Messages;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder{
        ...
        public MessageViewHolder(@NonNull View itemView) {
            super(itemView);
            senderMessageText = itemView.findViewById(R.id.text_message_send);
            senderTimeText = itemView.findViewById(R.id.text_message_time_send);
            receiverMessageText = itemView.findViewById(R.id.text_message_receiver);
            receiverTimeText = itemView.findViewById(R.id.text_message_time_receiver);
            receiverProfileImage = itemView.findViewById(R.id.image_message_profile);
        }
    }
