...
import info.project.hey.SndTaskActivity;

/**
 * A simple {@link Fragment} subclass.
 */
public class SndTaskFragment extends Fragment {
                                ...
                                if ("Murid".equals(level)) {
                                    ...
                                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            Intent sendIntent = new Intent(getContext(), SndTaskActivity.class);
                                            sendIntent.putExtra("visitId",userIds);
                                            sendIntent.putExtra("visitUserName",userName);
